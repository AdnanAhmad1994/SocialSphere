                    ...
                    <Card className="hover-elevate cursor-pointer h-full">
                      <CardHeader className="pb-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant="secondary" data-testid="badge-total-posts">
                            {stats.totalPosts}
                          </Badge>
                        </div>
                      </CardHeader>
                    ...
                    <Card className="hover-elevate border-l-4 border-l-chart-2 cursor-pointer h-full">
                      <CardHeader className="pb-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge className="bg-chart-2 text-white" data-testid="badge-pending-posts">
                            {stats.pendingPosts}
                          </Badge>
                        </div>
                      </CardHeader>
                    ...
                    <Card className="hover-elevate border-l-4 border-l-chart-1 cursor-pointer h-full">
                      <CardHeader className="pb-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge className="bg-chart-1 text-white" data-testid="badge-approved-posts">
                            {stats.approvedPosts}
                          </Badge>
                        </div>
                      </CardHeader>
